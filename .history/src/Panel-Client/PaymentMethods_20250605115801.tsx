          ...
          <div className="bg-white/70 rounded-lg p-8">
            ...
            <div className="space-y-8">
              <div className="flex flex-wrap gap-4">
                <div 
                  className={`relative border rounded-lg p-4 w-[140px] h-[80px] flex items-center justify-center cursor-pointer ${selectedMethod === 'bank' ? 'border-[#F7AD19] bg-white' : 'border-gray-200'}`}
                  onClick={() => handleMethodChange('bank')}
                >
                  {selectedMethod === 'bank' && (
                    <div className="absolute top-2 left-2 w-4 h-4 rounded-full bg-[#F7AD19]"></div>
                  )}
                ...
                <div 
                  className={`relative border rounded-lg p-4 w-[140px] h-[80px] flex items-center justify-center cursor-pointer ${selectedMethod === 'paypal' ? 'border-[#F7AD19] bg-white' : 'border-gray-200'}`}
                ...
                <div 
                  className={`relative border rounded-lg p-4 w-[140px] h-[80px] flex items-center justify-center cursor-pointer ${selectedMethod === 'webpay' ? 'border-[#F7AD19] bg-white' : 'border-gray-200'}`}
                ...
                <div 
                  className={`relative border rounded-lg p-4 w-[140px] h-[80px] flex items-center justify-center cursor-pointer ${selectedMethod === 'khipu' ? 'border-[#F7AD19] bg-white' : 'border-gray-200'}`}
