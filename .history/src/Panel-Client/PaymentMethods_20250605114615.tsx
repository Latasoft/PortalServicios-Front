          ...
          <div className="bg-white/70 rounded-lg p-8">
            ...
            <div className="space-y-8">
              <div className="flex flex-wrap gap-4">
                <div 
                  className={`border rounded-lg p-4 w-[120px] h-[60px] flex items-center justify-center cursor-pointer ${selectedMethod === 'bank' ? 'border-[#F7AD19] bg-white' : 'border-gray-200'}`}
                  onClick={() => handleMethodChange('bank')}
                >
                  <div className="text-[#053F5C] text-3xl flex items-center justify-center">
                    <span className="material-icons">account_balance</span>
                  </div>
                </div>
                
                <div 
                  className={`border rounded-lg p-4 w-[120px] h-[60px] flex items-center justify-center cursor-pointer ${selectedMethod === 'paypal' ? 'border-[#F7AD19] bg-white' : 'border-gray-200'}`}
                ...
                <div 
                  className={`border rounded-lg p-4 w-[120px] h-[60px] flex items-center justify-center cursor-pointer ${selectedMethod === 'webpay' ? 'border-[#F7AD19] bg-white' : 'border-gray-200'}`}
                  onClick={() => handleMethodChange('webpay')}
                >
                  <img src="https://www.webpay.cl/assets/img/logo-webpay.png" alt="WebPay" className="h-8" />
                </div>
                
                <div 
                  className={`border rounded-lg p-4 w-[120px] h-[60px] flex items-center justify-center cursor-pointer ${selectedMethod === 'khipu' ? 'border-[#F7AD19] bg-white' : 'border-gray-200'}`}
                  onClick={() => handleMethodChange('khipu')}
                >
                  <img src="https://www.khipu.com/assets/img/khipu-logo.png" alt="Khipu" className="h-8" />
                </div>
              </div>
