            ...
            <div className="space-y-8">
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center pl-5 relative">
                  <div className={`absolute w-4 h-4 rounded-full ${selectedMethod === 'bank' ? 'bg-[#F7AD19]' : 'border-2 border-gray-300'} left-0`}></div>
                  <div 
                ...
                <div className="flex items-center pl-5 relative">
                  <div className={`absolute w-4 h-4 rounded-full ${selectedMethod === 'paypal' ? 'bg-[#F7AD19]' : 'border-2 border-gray-300'} left-0`}></div>
                  <div 
                ...
                <div className="flex items-center pl-5 relative">
                  <div className={`absolute w-4 h-4 rounded-full ${selectedMethod === 'webpay' ? 'bg-[#F7AD19]' : 'border-2 border-gray-300'} left-0`}></div>
                  <div 
                ...
                <div className="flex items-center pl-5 relative">
                  <div className={`absolute w-4 h-4 rounded-full ${selectedMethod === 'khipu' ? 'bg-[#F7AD19]' : 'border-2 border-gray-300'} left-0`}></div>
                  <div 
