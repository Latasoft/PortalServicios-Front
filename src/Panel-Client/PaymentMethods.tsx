      ...
      <div className="max-w-[1200px] w-full flex gap-8 py-12">
        <div className="w-[250px] bg-white/70 rounded-lg p-6 space-y-4 h-fit">
          ...
          <nav className="space-y-2">
            ...
            <a href="/payment-methods" className="flex items-center gap-2 text-[#053F5C] font-medium p-2 hover:bg-white/50 rounded-lg">
          ...
          <div className="bg-white/70 rounded-lg p-8">
            ...
            <div className="space-y-8">
              <div className="flex flex-wrap gap-4">
                <label className="flex items-center pl-5 relative">
                  <input
                    type="radio"
                    name="paymentMethod"
                    value="bank"
                    ...
                    className="absolute left-0 w-4 h-4 appearance-none rounded-full border-2 border-gray-300 checked:bg-[#F7AD19] checked:border-[#F7AD19] transition-all cursor-pointer"
                  />
                  <div className={`border rounded-lg p-4 w-[140px] h-[80px] flex items-center justify-center cursor-pointer ${selectedMethod === 'bank' ? 'border-[#F7AD19] bg-white' : 'border-gray-200'}`}>
                ...
                <label className="flex items-center pl-5 relative">
                  <input
                    ...
                    className="absolute left-0 w-4 h-4 appearance-none rounded-full border-2 border-gray-300 checked:bg-[#F7AD19] checked:border-[#F7AD19] transition-all cursor-pointer"
                  />
                  <div className={`border rounded-lg p-4 w-[140px] h-[80px] flex items-center justify-center cursor-pointer ${selectedMethod === 'paypal' ? 'border-[#F7AD19] bg-white' : 'border-gray-200'}`}>
                ...
                <label className="flex items-center pl-5 relative">
                  <input
                    ...
                    className="absolute left-0 w-4 h-4 appearance-none rounded-full border-2 border-gray-300 checked:bg-[#F7AD19] checked:border-[#F7AD19] transition-all cursor-pointer"
                  />
                  <div className={`border rounded-lg p-4 w-[140px] h-[80px] flex items-center justify-center cursor-pointer ${selectedMethod === 'webpay' ? 'border-[#F7AD19] bg-white' : 'border-gray-200'}`}>
                ...
                <label className="flex items-center pl-5 relative">
                  <input
                    ...
                    name="paymentMethod"
                    value="khipu"
                    checked={selectedMethod === 'khipu'}
                    onChange={(e) => handleMethodChange(e.target.value)}
                    className="absolute left-0 w-4 h-4 appearance-none rounded-full border-2 border-gray-300 checked:bg-[#F7AD19] checked:border-[#F7AD19] transition-all cursor-pointer"
                  />
                  <div className={`border rounded-lg p-4 w-[140px] h-[80px] flex items-center justify-center cursor-pointer ${selectedMethod === 'khipu' ? 'border-[#F7AD19] bg-white' : 'border-gray-200'}`}>
